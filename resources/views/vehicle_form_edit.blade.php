      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <form action="<?php echo url('/'); ?>/vehicles/edit_save" method="post">
	  	  @csrf
            <div class="card-body">
              <div class="form-group">
                <label for="inputName">Plate</label>
                <input type="text" value="{{ $veh->plate }}" name="plate" id="inputName" class="form-control">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="id" value="{{ $id }}">
              </div>
              <div class="form-group">
                <label for="inputName">Nickname</label>
                <input type="text" value="{{ $veh->nickname }}"  name="nickname" id="inputName" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputStatus">Auth</label>
                <select name="authentication"   id="inputStatus" class="form-control custom-select">
                  <option value="{{ $veh->authentication }}">{{ $veh->authentication }}</option>
...
@endforeach
              ...
              <div class="form-group">
                ...
                <input name="brand"  value="{{ $veh->brand }}" type="text" name id="inputName" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputName">Model</label>
                <input name="model"  value="{{ $veh->model }}" type="text" id="inputName" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputName">Year</label>
                <input name="year" value="{{ $veh->year }}"  type="text" id="inputName" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputName">Type</label>
                <input name="type" value="{{ $veh->type }}"  type="text" id="inputName" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputName">Color</label>
                <input name="color" value="{{ $veh->color }}"  type="text" id="inputName" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputName">Status</label>
                <select name="status"   id="inputStatus" class="form-control custom-select">
                  <option value="{{$veh->status}}"><?php if ($veh->status == 1) {echo 'Active';} else {echo 'Inactive';}?></option>
